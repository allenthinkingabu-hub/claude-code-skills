...
| Pattern | Detection | ln-321 Call (Phase 2) | Output |
|---------|-----------|----------------------|--------|
...
**Phase 4 Criterion #17:** Checks docs exist + adds references (NO ln-321 calls).
...
**Phase 2 Integration:**
- Criteria #13-#17 DO NOT invoke ln-321 directly
- ln-321 invoked in Phase 2 for ALL detected patterns (ONE invocation per pattern)
