...
**Auto-fix actions:**
1. Count implementation Tasks (exclude final test Task created by ln-350)
2. IF <3 Tasks:
...
**Check:** No separate test Tasks BEFORE final Task (testing handled by ln-350 in final Task)

⚠️ **Critical:** Only ln-350-story-test-planner creates test Task as FINAL Task. No premature test Tasks allowed.
...
4. [Task] Comprehensive test suite - US-123-T4 (ln-350 creates this)
```
...
5. Add comment: "Test Tasks consolidated - ln-350 will create comprehensive test plan in final Task"
...
- Final comprehensive test Task covers all scenarios identified by ln-350
...
3. **[Task] Comprehensive test suite** - US-123-T3 (ln-350 creates)
   - Risk-based test plan covering all scenarios
```

**Skip Fix When:**
- Story in Done/Canceled status
- Final Task already created by ln-350
