...
See [task_template_implementation.md](../ln-311-task-creator/references/task_template_implementation.md) for detailed template (owned by ln-311-task-creator universal factory).
...
**Location**: Moved to [ln-311-task-creator/references/task_template_implementation.md](../ln-311-task-creator/references/task_template_implementation.md)
...
**Location**: Moved to [ln-312-task-replanner/references/replan_algorithm.md](../ln-312-task-replanner/references/replan_algorithm.md)
...
**Version:** 7.3.0 (Fixed Writing Style: "Use this skill when" → "This skill should be used when" for skill-creator compliance.)
