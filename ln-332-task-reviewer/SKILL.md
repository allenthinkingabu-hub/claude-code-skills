...
> No issues can be deferred "for later".
...
2. **Determine task type:**
   - **Test Task:** Has label "tests" OR created by ln-350-story-test-planner
...
**Reference:** For test tasks, see `ln-350-story-test-planner/references/test_task_template.md` for 11-section Story Finalizer structure and `ln-350-story-test-planner/references/risk_based_testing_guide.md` for Risk Priority methodology and test limits.
